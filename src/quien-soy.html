...
<html lang="es">
  <head>
    ...
    <style>
      ...
      .main-content {
        margin-left: 250px;
        padding: 80px 0 0 0; /* Se agrega padding-top para separar del top */
        flex-grow: 1;
      }
      .footer {
        margin-top: 250px;
    ...
    <div class="main-content">
      ...
      <section class="section">
        <div class="container">
          <h1>Sobre mi</h1>
          <p>
            Soy [Tu nombre], un apasionado del desarrollo web y la tecnología.
      ...
      <!-- Sección de Formación y Habilidades Técnicas -->
      <section class="section">
        <div class="container">
          <h2>Formación y Habilidades Técnicas</h2>
