...
<html lang="es">
  <head>
    ...
    <style>
      ...
      .main-content {
        margin-left: 250px;
        padding: 0; /* Eliminamos el padding para que no haya espacios innecesarios */
        flex-grow: 1;
      }
      .footer {
        margin-top: 250px;
      ...
      .card-container {
        ...
        padding: 20px; /* Añadimos padding para separar del borde */
      }
      .card {
        background-color: #1a0b2e; /* Color de fondo de las cards */
        border: none;
      ...
      .card-body {
        ...
        flex-grow: 1; /* Asegura que todas las cards tengan la misma altura */
        display: flex;
        flex-direction: column;
      }
      .card-title {
        ...
        <div class="card-container">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
              >
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Aplicación móvil de salud</h5>
              <p class="card-text">
                Desarrollo de una aplicación móvil para seguimiento de salud.
              </p>
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
              >
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">
                Implementación de un sistema de gestión de inventarios para
                pequeñas empresas.
              </p>
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">
                Desarrollo de una plataforma de aprendizaje en línea.
              </p>
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
              >
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Aplicación de finanzas personales</h5>
              <p class="card-text">
                Creación de una aplicación para la gestión de finanzas
                personales.
              </p>
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                Desarrollo de chatbot para atención al cliente
              </h5>
              <p class="card-text">
                Implementación de un chatbot para mejorar la atención al cliente
                en sitios web.
              </p>
              <a href="proyecto-ejemplo.html" class="btn btn-primary"
                >Ver Detalles</a
